...
export function MobileSignInPrompt({
  ...
  return (
    <div className="px-4 pt-8">
      <div className="rounded-2xl bg-white px-5 py-10 text-center" style={{ boxShadow: '0 10px 30px rgba(0,0,0,0.06)' }}>
        ...
        <button
          type="button"
          onClick={openSignIn}
          className="mx-auto mt-5 flex items-center justify-center gap-2 text-white transition active:scale-[0.98]"
          style={{
