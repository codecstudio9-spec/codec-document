...
// Full-admin only (not the analytics-only viewer role) — this provisions
// real institutional access, not just a read-only report.
const ADMIN_INSTITUTIONS_NAV_ITEM = {
