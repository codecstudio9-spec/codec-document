    ...
    >
      ...
      >
        ...
        <div className="space-y-5 p-5 sm:p-7">
          ...
          <DynamicDocForm nombreDocumento={template.name} mostrarDictado={false} fields={template.detectedFields} values={values} onChange={setFieldValue} language={language} invalidKeys={invalidKeys} />
