  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      const combined: RecentItem[] = [
        ...
        ...associated.map((d) => ({ id: d.id, name: d.name, status: d.status, date: d.created_at, href: d.signed_pdf_url || d.original_pdf_url || d.href || '' })),
    ...
    <div className="mx-auto max-w-6xl">
      ...
      <div className={`mt-6 grid gap-4 ${verDian ? 'grid-cols-5' : 'grid-cols-4'}`}>
        {[
          ...
          // mostrara a alguien que allá es rechazado, el botón llevaría a una
          // pantalla de error.
          ...(verDian
            ? [{
